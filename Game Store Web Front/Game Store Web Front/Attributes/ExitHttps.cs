...
{
    public class ExitHttps : FilterAttribute, IAuthorizationFilter
    {
        public void OnAuthorization(AuthorizationContext filterContext)
        {
            ...
            // redirect to HTTP
            string url = "http://" + filterContext.HttpContext.Request.Url.Host +":" +33932 +filterContext.HttpContext.Request.RawUrl;
